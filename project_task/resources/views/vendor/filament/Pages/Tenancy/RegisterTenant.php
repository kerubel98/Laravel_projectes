...
use Filament\Pages\Tenancy\view;
use Filament\Panel;
...
use pages\Pages\Concerns\InteractsWithFormActions;
use pages\Pages\SimplePage;
use Throwable;
...
{
    use \pages\Pages\Concerns\CanUseDatabaseTransactions;
    use \pages\Pages\Concerns\HasRoutes;
