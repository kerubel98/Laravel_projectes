...
namespace pages\Pages\Dashboard\Actions;
    ...
    protected function setUp(): void
    {
        ...
        $this->fillForm(function (Component $livewire): ?array {
            if (! property_exists($livewire, 'filters')) {
                throw new Exception('The [' . $livewire::class . '] page must implement the [' . \pages\Pages\Dashboard\Concerns\HasFilters::class . '] trait.');
            }
