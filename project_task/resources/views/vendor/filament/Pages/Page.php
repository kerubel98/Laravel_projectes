...
{
    use \pages\Pages\Concerns\CanAuthorizeAccess;
    use \pages\Pages\Concerns\HasRoutes;
    use \pages\Pages\Concerns\HasSubNavigation;
    use \pages\Pages\Concerns\InteractsWithHeaderActions;
    ...
    /**
     * @param  WidgetConfiguration $widgets
     * @return WidgetConfiguration
     */
